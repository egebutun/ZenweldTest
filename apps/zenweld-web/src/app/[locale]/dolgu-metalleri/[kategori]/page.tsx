...
export function generateStaticParams() {
  return categories
    .filter((category) => category.section === "dolgu-metalleri")
...
export async function generateMetadata({
  ...
  return {
    title,
    description,
    alternates: languageAlternates(`/dolgu-metalleri/${category.slug}`, lang),
    openGraph: {
      title,
      description,
...
export default async function CategoryPage({
  ...
  return <CategoryListing section="dolgu-metalleri" categorySlug={kategori} />;
}
